...
(function () {
  ...
  const CONTENT_EN = {
    ...
    trouble: () => el("div", { class: "prose" }, [
      ...
      h4("Refresh says it couldn't reach the price feed"),
      p("Browsers aren't allowed to call Yahoo Finance directly, so live stock prices route through public CORS relays. Those are third-party services and they rate-limit without warning. Nothing is broken — wait a minute and press Refresh again. Your committed daily snapshot keeps working regardless, which is why the chart still has history."),
      ...
      p("The holding is saved as soon as you press Add — the fetch that follows is separate. If the price didn't arrive, the holding is still in your list; press Refresh on its tab. Check the ticker matches the Yahoo Finance URL exactly, including the .JK suffix for Indonesian listings."),
  ...
  const CONTENT_ID = {
    ...
    trouble: () => el("div", { class: "prose" }, [
      ...
      h4("Refresh bilang tidak bisa menjangkau feed harga"),
      p("Browser tidak diizinkan memanggil Yahoo Finance secara langsung, jadi harga saham berjalan lewat relay CORS publik. Itu layanan pihak ketiga yang membatasi permintaan tanpa peringatan. Tidak ada yang rusak — tunggu sebentar lalu tekan Refresh lagi. Simpanan harian di repositorimu tetap bekerja, itulah sebabnya grafiknya masih punya riwayat."),
      ...
      p("Kepemilikannya sudah tersimpan begitu kamu menekan Add — pengambilan harga setelahnya adalah proses terpisah. Kalau harganya tidak datang, sahamnya tetap ada di daftarmu; tekan Refresh di tabnya. Pastikan kodenya persis sama dengan URL Yahoo Finance, termasuk akhiran .JK untuk saham Indonesia."),
